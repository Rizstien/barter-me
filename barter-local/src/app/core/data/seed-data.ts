...
export const MOCK_OFFERS: Offer[] = [
    ...
    createOffer({
        ...
        imageUrl: 'https://loremflickr.com/400/300/microwave,appliance?lock=1', condition: 'new'
    }),
    createOffer({
        ...
        imageUrl: 'https://loremflickr.com/400/300/books?lock=2', condition: 'good'
    }),
    createOffer({
        ...
        imageUrl: 'https://loremflickr.com/400/300/jacket?lock=3', condition: 'like-new'
    }),
    createOffer({
        ...
        imageUrl: 'https://loremflickr.com/400/300/tennis?lock=4', condition: 'fair'
    }),
    ...
    createOffer({
        ...
        imageUrl: 'https://loremflickr.com/400/300/macbook?lock=5', condition: 'excellent'
    }),
    createOffer({
        ...
        imageUrl: 'https://loremflickr.com/400/300/lamp?lock=6', condition: 'like-new'
    }),
    createOffer({
        ...
        imageUrl: 'https://loremflickr.com/400/300/yoga?lock=7', condition: 'good'
    }),
    createOffer({
        ...
        imageUrl: 'https://loremflickr.com/400/300/coffeemaker?lock=8', condition: 'good'
    }),
    ...
    createOffer({
        ...
        imageUrl: 'https://loremflickr.com/400/300/bicycle?lock=9', condition: 'excellent'
    }),
    createOffer({
        ...
        imageUrl: 'https://loremflickr.com/400/300/tools?lock=10', condition: 'good'
    }),
    createOffer({
        ...
        imageUrl: 'https://loremflickr.com/400/300/bag?lock=11', condition: 'good'
    }),
    createOffer({
        ...
        imageUrl: 'https://loremflickr.com/400/300/tent?lock=12', condition: 'like-new'
    }),
    ...
    createOffer({
        ...
        imageUrl: 'https://loremflickr.com/400/300/playstation?lock=13', condition: 'excellent'
    }),
    createOffer({
        ...
        imageUrl: 'https://loremflickr.com/400/300/headset?lock=14', condition: 'like-new'
    }),
    createOffer({
        ...
        imageUrl: 'https://loremflickr.com/400/300/tablet?lock=15', condition: 'good'
    }),
    createOffer({
